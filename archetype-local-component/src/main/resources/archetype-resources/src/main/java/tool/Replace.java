...
public class Replace {
	public static void main(String[] args) throws Exception {
		...
		while(line!=null) {
			strBuf.append(line+"${symbol_escape}n");
			String val = line;	
			while(val.contains("${symbol_dollar}{")) {
				String envKey = val.substring(val.indexOf("${symbol_dollar}{")+2, val.indexOf("}"));
				System.out.print(">              find var ${symbol_dollar}{"+envKey+"}");
	...
	/**
     * 将字符串template中由${symbol_dollar}{key}组成的占位符依次替换为data中相应的值覆盖
     * @param template
     * @param data
     * @return
     * @throws Exception
    ...
    private static String templateParse(String template, Map<String,String> data) {  
        String regex = "${symbol_escape}${symbol_escape}${symbol_dollar}${symbol_escape}${symbol_escape}{(.+?)${symbol_escape}${symbol_escape}}";  
...
//            if (value == null) {  
//                value = matcher.group(0).replaceAll("${symbol_escape}${symbol_escape}${symbol_dollar}", "${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_dollar}");
//            } else {   
//                value = value.replaceAll("${symbol_escape}${symbol_escape}${symbol_dollar}", "${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_dollar}"); 
//            }  
